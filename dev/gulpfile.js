...
function devJSON() {
  return src([`${options.paths.src.base}/*.json`, `${options.paths.src.base}/languages/*.json`])
    .pipe(dest('../languages'));
}
function devMeta() {
  return src(`${options.paths.src.base}/metadata.json`)
    .pipe(dest('../'));
}
...
function devClean() {
  ...
  return src(['../**/*', '!../dev/**/*.json', '!../dev/**/*.php', '!../dev/**/*.css', '!../dev/**/*.js'])
...
function prodJSON() {
  return src(`${options.paths.src.base}/languages/*.json`)
    .pipe(dest(`${options.paths.build.base}/languages`));
}
function prodMeta() {
  return src(`${options.paths.src.base}/metadata.json`)
    .pipe(dest(options.paths.build.base));
...
exports.default = series(
  ...
  parallel(devStyles, devScripts, devImages, devFonts, devThirdParty, devHTML, devJSON, devMeta), //Run All tasks in parallel
